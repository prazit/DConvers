...
public class FTPValue extends DynamicValue {

    private DataString dataString;

    public FTPValue(Application application, String targetName, String targetColumnName, Integer targetColumnIndex) {
    ...
    public void prepare(String sourceName, String sourceColumnName, DynamicValueType sourceColumnType, String sourceColumnArg) {
        ...
        String value = converter.valueFromFtp(sourceColumnName);
        if (value == null) {
            dataString = null;
        } else {
    ...
    protected Logger loadLogger() {
        return LoggerFactory.getLogger(FTPValue.class);
    }
}
