    ...
    protected Writer openWriter(OutputConfig outputConfig, DataTable dataTable) {
        ...
        if (owner instanceof Source) {
            ...
            headPrint = "--" + eol
                    ...
                    + "-- This sql file contains " + dataTable.getRowCount() + " rows from source(" + source.getName() + ") in converter(" + name + ")" + eol
            ...
            headPrint = "--" + eol
                    + "-- Generated by dconvers at " + application.getSystemVariableValue(SystemVariable.NOW) + "." + eol
                    + "-- This sql file contains " + dataTable.getRowCount() + " rows from target(" + target.getName() + ") in converter(" + name + ")" + eol
