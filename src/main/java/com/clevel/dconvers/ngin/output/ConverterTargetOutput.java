...
public class ConverterTargetOutput extends Output {
    public ConverterTargetOutput(Application application, String name) {
    ...
    protected Logger loadLogger() {
        return LoggerFactory.getLogger(ConverterTargetOutput.class);
    }
}
